...
DATABASES = {
    'default': {
        ...
        'HOST': 'aws-capstone-rds.chxxalbhxe8t.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'bilalblog' # please enter your s3 bucket name
